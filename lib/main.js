...
export function activate (_state) {
  trace = localStorage.getItem('orgfld-trace') === 'true' // eslint-disable-line
  // todo: subscribe to changes and update value of trace
  subscriptions = new CompositeDisposable()
  subscriptions.add(
    atom.commands.add('atom-workspace', {
      'orgfld:fold-all': () => foldAtLevel(1),
      'orgfld:unfold-all': () => unfoldAll(),
      'orgfld:fold-at-heading-level-1': () => foldAtLevel(1),
      'orgfld:fold-at-heading-level-2': () => foldAtLevel(2),
      'orgfld:fold-at-heading-level-3': () => foldAtLevel(3),
      'orgfld:fold-at-heading-level-4': () => foldAtLevel(4),
      'orgfld:fold-at-heading-level-5': () => foldAtLevel(5),
      'orgfld:fold-at-heading-level-6': () => foldAtLevel(6),
      'orgfld:fold-current-row': () => foldCurrentRow(),
    })
  )
}
